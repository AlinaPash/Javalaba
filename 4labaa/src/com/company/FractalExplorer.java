...
public class FractalExplorer {
    ...
    public static void main(String[] args) {// точка входа
        ...
        fractalExplorer.setGUI(); fractalExplorer.drawFractal(); }
    public void setGUI() {// задание интерфейса
        ...
        buttonReset.setActionCommand("Reset"); // кнопка reset
        buttonReset.addActionListener(new ActionHandler());
        buttonSave.setActionCommand("Save"); // кнопка сохранить
...
private void drawFractal() { // отрисовка фрактала в JImageDisplay
        for (int x = 0; x < displaySize; x++) {
            for (int y = 0; y < displaySize; y++) {
                int counter =
                        fractalGenerator.numIterations(FractalGenerator.getCoord(range.x,
                        range.x + range.width, displaySize, x),
                                fractalGenerator.getCoord(range.y,
    ...
    public class ActionHandler implements ActionListener { // обработчик кнопок
        @Override
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand().equals("Reset")) {
                fractalGenerator.getInitialRange(range); drawFractal(); } // перерисовка фрактала
            else if (e.getActionCommand().equals("Save")) { // сохранение
               ...
               if (t == JFileChooser.APPROVE_OPTION) {
                   try {
                       ...
                       JOptionPane.showMessageDialog(imageDisplay, ee.getMessage(),
...
comboBox.getSelectedItem();
    ...
    public class MouseListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            fractalGenerator.recenterAndZoomRange(range, x, y, 0.25);
            drawFractal();}
    }
}